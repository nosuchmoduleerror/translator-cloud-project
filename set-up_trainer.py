...
def connection():
    ...
    parser.add_argument("--address", "-ip", help="IP of the database", required=True)
    parser.add_argument("--user", "-u", help="username to login on the DB", default="neo4j")
    parser.add_argument("--password", "-p", help="password to login to the DB", default="password")
